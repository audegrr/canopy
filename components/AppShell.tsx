      ...
      >
        ...
        <div style={{ height: '52px', padding: '0 16px', borderBottom: '1px solid var(--border)', background: 'var(--topbar-bg)', backdropFilter: 'saturate(180%) blur(8px)', WebkitBackdropFilter: 'saturate(180%) blur(8px)', display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0, position: 'sticky', top: 0, zIndex: 10 }}>
          ...
          <button onClick={() => window.location.reload()}
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'var(--sidebar-hover)' }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'none' }}
            title="Refresh"><Icon name="refresh" size={13} /></button>
          ...
          <div style={{ display: 'flex', alignItems: 'center', flexShrink: 0, border: '1px solid var(--border)', borderRadius: '6px', overflow: 'hidden' }}>
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: zoom === ZOOM_LEVELS[0] ? 'default' : 'pointer', color: zoom === ZOOM_LEVELS[0] ? 'var(--text-tertiary)' : 'var(--text-secondary)', fontSize: isMobile ? '16px' : '13px', fontWeight: 400, padding: isMobile ? '10px 14px' : '5px 8px', fontFamily: 'var(--font-sans)', borderRight: '1px solid var(--border)', touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' as any, minWidth: isMobile ? '44px' : undefined, minHeight: isMobile ? '44px' : undefined, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            ...
            {!isMobile && (
              <button
                ...
                style={{ background: zoom !== 1.0 ? 'var(--accent-light)' : 'none', border: 'none', cursor: zoom !== 1.0 ? 'pointer' : 'default', color: zoom !== 1.0 ? 'var(--accent)' : 'var(--text-tertiary)', fontSize: '11px', fontWeight: 500, padding: '5px 6px', fontFamily: 'var(--font-sans)', minWidth: '34px', textAlign: 'center' }}
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: zoom === ZOOM_LEVELS[ZOOM_LEVELS.length-1] ? 'default' : 'pointer', color: zoom === ZOOM_LEVELS[ZOOM_LEVELS.length-1] ? 'var(--text-tertiary)' : 'var(--text-secondary)', fontSize: isMobile ? '16px' : '13px', fontWeight: 400, padding: isMobile ? '10px 14px' : '5px 8px', fontFamily: 'var(--font-sans)', borderLeft: '1px solid var(--border)', touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' as any, minWidth: isMobile ? '44px' : undefined, minHeight: isMobile ? '44px' : undefined, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
