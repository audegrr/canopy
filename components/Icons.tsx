...
const ICONS: Record<string, () => React.ReactNode> = {
  ...
  loader: () => <>
    <path d="M12 4v4"/>
    <path d="M17.66 6.34 15.54 8.46"/>
    <path d="M20 12h-4"/>
    <path d="M17.66 17.66 15.54 15.54"/>
    <path d="M12 20v-4"/>
    <path d="M6.34 17.66 8.46 15.54"/>
    <path d="M4 12h4"/>
    <path d="M6.34 6.34 8.46 8.46"/>
  </>,
  ...
  'list-ordered': () => <>
    ...
    <path d="M6 2v7" strokeWidth={0.9}/>
    <path d="M4 4 6 2" strokeWidth={0.9}/>
    <path d="M2.7 14.6c0-1.8 1.3-2.9 2.8-2.9s2.8.9 2.8 2c0 2-3.3 2.9-5.5 5.4h5.5" strokeWidth={0.9}/>
  </>,
  'list-todo': () => <>
  ...
  quote: () => <g transform="translate(0,2.5)">
    <path fill="currentColor" stroke="none" d="M7.46 11.98H7.75Q8.94 11.98 9.89 12.89Q10.83 13.79 10.83 15.15Q10.83 16.48 9.89 17.34Q8.94 18.21 7.54 18.21Q6.02 18.21 5.01 16.99Q4 15.77 4 13.52Q4 11.46 4.89 9.66Q5.77 7.85 7.05 6.8Q8.33 5.75 9.33 5.75Q10 5.75 10.38 6.15Q10.75 6.54 10.75 7.17Q10.75 8.08 9.94 8.52Q8.83 9.12 8.19 9.94Q7.54 10.75 7.46 11.98Z"/>
    <path fill="currentColor" stroke="none" d="M16.67 11.98H16.94Q18.1 11.98 19.05 12.89Q20 13.79 20 15.15Q20 16.46 19.05 17.35Q18.1 18.25 16.71 18.25Q15.17 18.25 14.17 17Q13.17 15.75 13.17 13.52Q13.17 11.92 13.69 10.5Q14.21 9.08 15.03 8.03Q15.85 6.98 16.8 6.36Q17.75 5.75 18.5 5.75Q19.19 5.75 19.55 6.14Q19.92 6.52 19.92 7.17Q19.92 8.1 19.1 8.52Q17.96 9.17 17.38 9.95Q16.79 10.73 16.67 11.98Z"/>
  </g>,
  callout: () => <>
    <circle cx="12" cy="12" r="10"/>
    <path d="M12 17v-5"/>
